...
__all__ = ['set_seed', 'TL_RAND_SEED', 'in_notebook', 'convert_to_snakecase', 'RAW_DATA_PATH', 'CLEAN_DATA_PATH',
           'LM_PATH', 'CLS_PATH', 'SENTIMENT_CLS_PATH', 'STANDARD_THEME_PATH', 'STANDARD_THEME_CSS_PATH',
           'STANDARD_THEME_SAW_PATH', 'STANDARD_THEME_META_PATH', 'SUMMARIZATION_PATH', 'ADHOC_THEME_PATH',
...
def set_seed(seed_value=TL_RAND_SEED):
...
# Cell
def in_notebook():
    """Returns True if code is running in a notebook.  Helpful if you need to not run certain code when
    running via script
    """
    try:
