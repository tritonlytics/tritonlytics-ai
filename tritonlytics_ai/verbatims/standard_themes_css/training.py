# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/02d_verbatims-standard-themes-css-training.ipynb (unless otherwise specified).

__all__ = ['get_metrics', 'get_loss_func', 'get_cbs', 'get_learner', 'train', 'objective', 'get_standard_theme_preds']
